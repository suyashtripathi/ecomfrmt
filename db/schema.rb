...
ActiveRecord::Schema.define(version: 2019_09_22_164657) do
  ...
  create_table "spree_asset_view_types", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_spree_asset_view_types_on_name"
  end
  ...
  create_table "spree_card_previews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["number"], name: "index_spree_card_previews_on_number"
  end
  ...
  create_table "spree_front_type1_data", force: :cascade do |t|
  ...
  create_table "spree_inside_tpl_cfgs", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "prod_ctg"
    t.string "prod_key"
    t.index ["name"], name: "index_spree_inside_tpl_cfgs_on_name"
  end

  create_table "spree_inside_type1_data", force: :cascade do |t|
    t.integer "card_preview_id"
    t.string "ta_1_text"
    t.string "ta_1_font"
    t.integer "ta_1_fontsize"
  ...
  create_table "spree_message_categories", force: :cascade do |t|
    t.string "name"
    t.boolean "is_visible"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_spree_message_categories_on_name"
  end

  create_table "spree_message_repositories", force: :cascade do |t|
    t.integer "msg_category_id"
    t.string "message"
    t.boolean "is_visible"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["msg_category_id"], name: "index_spree_message_repositories_on_msg_category_id"
  end
  ...
  create_table "spree_photo_text_cfgs", force: :cascade do |t|
    t.string "type"
    t.string "name"
    t.integer "x"
    t.integer "y"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inside_tpl_cfg_id"], name: "index_spree_photo_text_cfgs_on_inside_tpl_cfg_id"
    t.index ["page"], name: "index_spree_photo_text_cfgs_on_page"
    t.index ["variant_id"], name: "index_spree_photo_text_cfgs_on_variant_id"
  end
  ...
  create_table "spree_product_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_spree_product_categories_on_name"
  end
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.boolean "is_it_new", default: false
    t.string "front_desc"
    t.string "inside_desc"
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.index ["mobile_num"], name: "index_spree_users_on_mobile_num"
